"""
Django settings for jcbdhj_17 project.
...
WSGI_APPLICATION = 'jcbdhj_17.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jcbdhj_17 API",
    "DESCRIPTION": "API documentation for jcbdhj_17 App",
    "VERSION": "v1",
}
